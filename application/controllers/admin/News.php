...
class News extends CI_Controller
{
	...
	public function add()
	{
		...
		if (isset($_POST['form1'])) {
			...
			$this->form_validation->set_rules('news_title', 'Judul Berita', 'trim|required');
			$this->form_validation->set_rules('news_content_short', 'Deskripsi Singkat', 'trim|required');
			$this->form_validation->set_rules('news_content', 'Deskripsi Lengkap', 'trim|required');
