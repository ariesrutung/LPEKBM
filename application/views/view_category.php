                ...
                foreach ($news_by_category as $row) {
                    ...
                    <div class="blog-one-item">
                        ...
                        <div class="blog-one-text">
                            <ul>
                                <li><i class="bi bi-edit"></i><a href="<?php echo base_url(); ?>category/<?php echo $row['category_id']; ?>"><?php echo $category['category_name']; ?></a></li>
                            ...
                            <div class="button-df">
                                <a href="<?php echo base_url(); ?>news/view/<?php echo $row['news_id']; ?>"><?php echo READ_MORE; ?> <i class="bi bi-chevron-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                <?php
