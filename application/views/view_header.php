...
<head>
    ...
    <style>
        ...
        /* CSS Baru */
        /* .lang-right select.form-control {
            font-size: 0;
            background-image: url(https://kemenparekraf.go.id/assets/images/flags/ID.svg) !important;
                ...
                <div class="col-lg-9 col-12 main-menu">
                    <div class="main-menu-item">
                        <ul class="nav-menu">
                            ...
                            <?php if (($arr_menu[3] == 'Show') || ($arr_menu[3] == 'Show') || ($arr_menu[4] == 'Show') || ($arr_menu[5] == 'Show') || ($arr_menu[6] == 'Show') || ($arr_menu[7] == 'Show') || ($arr_menu[8] == 'Show') || ($d_page == 1)) : ?>
