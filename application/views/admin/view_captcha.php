					...
					<div class="form-group">
						<div class="col-sm-12">
							<div class="text-danger" role="alert">
								<strong>Info!</strong> Pengaturan Capta menggunakan operasi aritmatika. Tujuannya agar pesan yang dikirim dari user harus berasal dari manusia dan bukan robot.
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<a href="<?php echo base_url(); ?>admin/captcha/delete/<?php echo $row['captcha_id']; ?>" class="btn btn-danger btn-xs" onClick="return confirm('Are you sure?');">Hapus</a>
									</td>
								</tr>
							<?php
							}
