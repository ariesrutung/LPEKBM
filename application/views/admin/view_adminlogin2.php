                    ...
                    <div class="col-lg-6">
                        <div class="card2 card border-0 px-4 py-5">
                            <div class="row mb-4 px-3">
                                <b>
                                    <?php echo $setting_data['website_name']; ?> - Masuk Panel Admin
                                </b>
                            </div>
                            ...
                            <div class="row px-3 form-group has-feedback">
                                ...
                                <input class="form-control mb-4" placeholder="Email address" name="email" type="email" autocomplete="off" autofocus>
                            </div>
                            <div class="row px-3 form-group has-feedback">
                                <label class="mb-1">
                                    <h6 class="mb-0 text-sm">Password</h6>
                                </label>
                                <input class="form-control" placeholder="Kata Sandi" name="password" type="password" autocomplete="off">
                            ...
                            <div class="row px-3 mb-4">
                                ...
                                <a class="ml-auto mb-0 text-sm" href="<?php echo base_url(); ?>admin/forget-password" style="color:red;">Lupa Kata Sandi?</a>

                            </div>
                            <div class="row mb-3 px-3">
                                <input type="submit" class="btn btn-blue btn-block btn-flat login-button" name="form1" value="Login">
                            </div>
                            <?php echo form_close(); ?>
                        </div>
                    </div>
