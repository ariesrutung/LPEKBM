...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>admin/portfolio" class="btn btn-primary btn-sm">Lihat Semua</a>
	</div>
</section>
		...
		<div class="col-md-12">
			...
			<div class="box box-info">
				<div class="box-body">
					...
					<div class="form-group">
						<label for="" class="col-sm-2 control-label">Deskripsi Lengkap *</label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label for="" class="col-sm-2 control-label">Nama Klien</label>
						<div class="col-sm-4">
					...
					<div class="form-group">
						<label for="" class="col-sm-2 control-label">Perusahan Klien</label>
						<div class="col-sm-4">
					...
					<div class="form-group">
						<label for="" class="col-sm-2 control-label">Biaya</label>
						<div class="col-sm-4">
					...
					<div class="form-group">
						<label for="" class="col-sm-2 control-label">Komentar Klien</label>
						<div class="col-sm-8">
					...
					<h3 class="seo-info">Foto Fitur</h3>
					<div class="form-group">
						<label for="" class="col-sm-2 control-label">Pilih Foto Fitur *</label>
						<div class="col-sm-9" style="padding-top:5px">
							<input type="file" name="photo">(Hanya .jpg, .jpeg, .gif dan .png yang diizinkan)
						</div>
					</div>
					<h3 class="seo-info">Foto Lainnya</h3>
					<div class="form-group">
						<label for="" class="col-sm-2 control-label">Pilih Foto Lainnya</label>
						...
						<div class="col-sm-2" style="padding-top:5px">
							<input type="button" id="btnAddNew" value="Tambah Item" style="margin-bottom:10px;border:0;color: #fff;font-size: 14px;border-radius:3px;" class="btn btn-warning btn-xs">
						</div>
					</div>
					<h3 class="seo-info">Informasi SEO</h3>
					<div class="form-group">
						<label for="" class="col-sm-2 control-label">Judl Meta</label>
						<div class="col-sm-6">
