				...
				<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-6" style="padding-top:5px">
							<input type="file" name="photo">(Hanya .jpg, .gif, dan .png yang diperbolehkan.)
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<select name="position" class="form-control select2">
								<option value="Left" <?php if ($slider['position'] == 'Left') {
															echo 'selected';
														} ?>>Left</option>
								<option value="Right" <?php if ($slider['position'] == 'Right') {
															echo 'selected';
														} ?>>Right</option>
							</select>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<select name="lang_id" class="form-control select2">
								...
								?><option value="<?php echo $row['lang_id']; ?>" <?php if ($slider['lang_id'] == $row['lang_id']) {
																						echo 'selected';
