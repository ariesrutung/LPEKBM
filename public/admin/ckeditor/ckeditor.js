...
(function() {
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) { var d = CKEDITOR.event.prototype,
        ...
        return {
            ...
            on: function(b, d, g, h, k) {
                ...
                function q() { C.removeListener(b, d) } var f = a.call(this, b); if (0 > f.getListenerIndex(d)) { f = f.listeners;
                    g || (g = this);
                    isNaN(k) && (k = 10); var C = this;
                    n.fn = d;
    ...
    (function() {
        function a(a, b) {
            ...
            if (a && !this._.guardRTL) { var r = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(),
    ...
    (function() {
        ...
        function d(a, b, c, d, e) {
            function g(a, b, c, f) { var d = c ? a.getPrevious() : a.getNext(); if (f && k) return d;
                l || f ? b.append(a.clone(!0, e), c) : (a.remove(), q && b.append(a)); return d }
            ...
            if (l && I.type == CKEDITOR.NODE_TEXT && u.equals(I)) u = a.document.createText(u.substring(J, D)), c.append(u);
                ...
                for (var O = u.getParents(), p = I.getParents(), F = m(), t = O.length - 1, G = p.length - 1, N = c, Z, X, U, ea = -1, P = F; P <= t; P++) {
                    X =
                        O[P];
                    U = X.getNext();
                    for (P != t || X.equals(p[P]) && t < G ? b && (Z = N.append(X.clone(0, e))) : r ? g(X, N, !1, v) : L && N.append(a.document.createText(X.substring(J))); U;) { if (U.equals(p[P])) { ea = P; break }
                        U = g(U, N) }
                    N = Z
                }
                N = c;
                for (P = F; P <= G; P++)
                    ...
                    else { P != G || c.equals(O[P]) && G < t ? b && (Z = N.append(c.clone(0, e))) : z ? g(c, N, !1, B) : n && N.append(a.document.createText(c.substring(0, D))); if (P > ea)
                            for (; U;) U = g(U, N, !0);
                        N = Z }
                l || h()
            }
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        var g = function(a, b) {
                            ...
                            for (c.guard = function(a) { return !(a.type == CKEDITOR.NODE_ELEMENT && a.isBlockBoundary()) }; f =
                                ...
                                r = f != a ? f.getText() : f.substring(b); if (d.test(r)) return !1 }
                            return !0
                        };
                        ...
                        for (l = c(l); l || u;) {
                            ...
                            for (; u;)
                                if (D = !1, u.type == CKEDITOR.NODE_COMMENT) u = u.getPrevious();
                                    ...
                                    if (u) { D = u.getPrevious(); if (!l && !D) { l = u;
                                            u = null; break }
                                        u = D } else l = null
                                }
                            l && (l = c(l.getParent()))
                        ...
                        for (; l ||
                            u;) {
                            if (l && !u) {!I && l.equals(m) && (I = !0); if (e ? l.isBlockBoundary() : !h.contains(l)) break;
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var L, n, O = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null),
                            p = null,
                            F = function(a) { if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable"))
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) { l = this.clone();
                            ...
                            l.evaluator = function(a) { return !t(a) && !G(a) }; if ((l = l.previous()) && l.type == CKEDITOR.NODE_ELEMENT && l.is("br")) break }
                        l = this.clone();
                        l.collapse();
            ...
            getNextParagraph: function(a) {
                ...
                for (this._.nextNode = null; m;) {
                    ...
                    if (H) m.type == CKEDITOR.NODE_TEXT && e.test(m.getText()) && (H = 0);
                        ...
                        var u = m.getName();
                        if (CKEDITOR.dtd.$block[u] && "false" == m.getAttribute("contenteditable")) { d = m;
                            b(this, a, d); break } else if (m.isBlockBoundary(this.forceBrBreak && !y && { br: 1 })) { if ("br" == u) H = 1;
                            else if (!h && !m.getChildCount() && "hr" != u) { d = m;
                                w = m.equals(x); break }
                            ...
                            K = 1 } else { if (m.getFirst()) { h || (h = this.range.clone(), h.setStartAt(m, CKEDITOR.POSITION_BEFORE_START));
                                m = m.getFirst(); continue }
                            H = 1 }
                    }
                    H && !h && (h = this.range.clone(), h.setStartAt(m, CKEDITOR.POSITION_BEFORE_START));
                    w = (!K || H) && m.equals(x);
                    if (h && !K)
                        for (; !m.getNext(k) && !w;) { u = m.getParent(); if (u.isBlockBoundary(this.forceBrBreak && !y && { br: 1 })) { K = 1;
                                H = 0;
                                w || u.equals(x);
                                h.setEndAt(u, CKEDITOR.POSITION_BEFORE_END); break }
                            m = u;
                            H = 1;
                            w = m.equals(x);
                            l = 1 }
    ...
    (function() {
        function a(a, b, c, d, e) {
            ...
            for (d = a.length; c < d; ++c) {
                ...
                for (g in O) { r = O[g];
                    u = t[r];
                    m = [];
                    G = void 0; for (G in u) - 1 < G.indexOf("*") ? m.push(new RegExp("^" + G.replace(/\*/g, ".*") + "$")) : m.push(G);
                    u = m;
                    u.length && (t[r] = u, p = !1) }
                t.nothingRequired = p;
        ...
        function c(a, b, c) { if (!a.match || a.match(b)) { if (a.noProperties) return !1;
                ...
                a = a.classes;
                b = b.classes; if (a) { for (var d = !1, l = !0 === a, f = b.length; f--;)
        ...
        function f(a) { var b, c, d, e, l = {},
                f = 1; for (a = B(a); b = a.match(p);)(c = b[2]) ? (d = C(c, "styles"), e = C(c, "attrs"), c = C(c, "classes")) : d = e = c = null, l["$" + f++] = { elements: b[1], classes: c, styles: d, attributes: e }, a = a.slice(b[0].length); return l }
        ...
        function A(a, b, e, l) {
            ...
            if (l.doCallbacks && a.elementCallbacks) { a: { r = a.elementCallbacks; for (var v = 0, g = r.length, p; v < g; ++v)
                        if (p = r[v](b)) { r = p; break a }
                    r = void 0 } if (r) return r }
            if (l.doTransform && (r = a._.transformations[b.name])) { w(b); for (v = 0; v < r.length; ++v) u(a, b, r[v]);
                x(b) }
            if (l.doFilter) {
                a: {
                    ...
                    if (a || r) { w(b); if (v)
                        ...
                        if (g)
                            for (h = 0, B = g.length; h < B; ++h) c(g[h], b, z); if (a)
                            for (h = 0, B = a.length; h < B; ++h) d(a[h], b, z, p); if (r)
                ...
                if (!a.allStyles || a.hadInvalidStyle) { for (k in I) a.allStyles || F[k] ? D.push(k + ":" + I[k]) : h = !0;
                    D.length && (v.style = D.sort().join("; ")) } else J && (v.style = J);
                if (!a.allClasses ||
                    a.hadInvalidClass) { for (k = 0; k < g.length; ++k)(a.allClasses || r[g[k]]) && z.push(g[k]);
                    z.length && (v["class"] = z.sort().join(" "));
                    p && z.length < p.split(/\s+/).length && (h = !0) } else p && (v["class"] = p);h && (f = 1);
        ...
        CKEDITOR.filter.prototype = {
            ...
            addContentForms: function(a) { if (!this.disabled && a) { var b, c, d = [],
                        e; for (b = 0; b < a.length && !e; ++b) c = a[b], ("string" == typeof c || c instanceof CKEDITOR.style) && this.check(c) && (e = c); if (e) { for (b = 0; b < a.length; ++b) d.push(J(a[b], e));
            ...
            transform: function(a, b) {
                if ("string" == typeof b) a.name = b;
                    ...
                    for (l in e)
                        if ("class" ==
                            l)
                            for (c = a.classes.join("|"), f = e[l].split(/\s+/); v = f.pop();) - 1 == c.indexOf(v) && a.classes.push(v);
            ...
            CKEDITOR.plugins.load(c.split(","), function(c) {
                ...
                CKEDITOR.scriptLoader.load(f, function() {
                    for (var c = ["beforeInit", "init", "afterInit"], l = 0; l < c.length; l++)
                        for (var f =
                                0; f < d.length; f++) { var v = d[f];
                            0 === l && e[f] && v.lang && v.langEntries && (a.lang[v.name] = v.langEntries[e[f]]); if (v[c[l]]) v[c[l]](a) }
            ...
            parse: function(b) {
                for (var c, e, g = 0, h; c = this._.htmlPartsRegex.exec(b);) {
                    ...
                    if (h) h.push(c[0]);
                            ...
                            this.onTagOpen(e, k, c);!h && CKEDITOR.dtd.$cdata[e] && (h = []) } } else if (e = c[2]) this.onComment(e)
                }
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function(g, h, k) {
                ...
                function C(b, c, d) { c = c || y || x; var e = y;
                ...
                E.onText = function(a) { if (!(y._.hasInlineStarted && !K.length || l || H) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return; var b = y.name,
                        f = b ? CKEDITOR.dtd[b] || (y._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c; if (!H && !f["#"] && b in d) E.onTagOpen(e[b] || ""), E.onText(a);
                    else { q();
                        n();
                        l || H || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
                        a = new CKEDITOR.htmlParser.text(a); if (w(y, a)) this.onTagOpen(k, {}, 0, 1);
                        y.add(a) } };
                E.onCDATA =
                    function(a) { y.add(new CKEDITOR.htmlParser.cdata(a)) };
                E.onComment = function(a) { q();
                    n();
            ...
            D = {
                ...
                elements: {
                    ...
                    table: function(a) { a.children.slice(0).sort(function(a, b) { var c, d;
                            a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type && (c = CKEDITOR.tools.indexOf(H, a.name), d = CKEDITOR.tools.indexOf(H, b.name)); - 1 < c && -1 < d && c != d || (c = a.parent ? a.getIndex() : -1, d = b.parent ? b.getIndex() : -1); return c > d ? 1 : -1 }) },
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            filter: function(a, b) {
                ...
                for (;;) { h = d.name; if (!(k = a.onElementName(b, h))) return this.remove(), !1;
                    d.name = k; if (!(d = a.onElement(b, d))) return this.remove(), !1; if (d !== this) return this.replaceWith(d), !1; if (d.name == h) break; if (d.type != CKEDITOR.NODE_ELEMENT) return this.replaceWith(d), !1; if (!d.name) return this.replaceWithChildren(), !1 }
                h = d.attributes;
                var n, q;
                for (n in h) {
                    for (k = h[n];;)
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                getHtmlFromRange: function(a) { if (a.collapsed) return new CKEDITOR.dom.documentFragment(a.document);
                    ...
                    y.eol.fix(a, this); return new CKEDITOR.dom.documentFragment(a.fragment.$) },
                extractHtmlFromRange: function(a, b) {
                    ...
                    if (b) { c = a.startPath(); if (d = a.checkStartOfBlock() && a.checkEndOfBlock() && c.block && !a.root.equals(c.block)) { a: { var d = c.block.getElementsByTag("span"),
                                ...
                                d = !1 }
                            d = !d }
                        d && (a.moveToPosition(c.block, CKEDITOR.POSITION_BEFORE_START), c.block.remove()) } else c.autoParagraph(this.editor, a), w(a.startContainer) && a.startContainer.appendBogus();
        ...
        x = function() {
            ...
            return function(B, p, F, t) {
                ...
                if (!t.checkReadOnly()) {
                    ...
                    if (!p.collapsed) { var G = q.block || q.blockLimit,
                    ...
                    if (m = F) {
                        ...
                        if (/^\s+|\s+$/.test(F) && "span" in CKEDITOR.dtd[w]) { var C = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e';
                            F = C + F + C }
                        ...
                        if ((C = m.startPath().block) && (1 != C.getChildCount() || !C.getBogus())) a: {
                            var A;
                            if (1 ==
                                w.getChildCount() && a(A = w.getFirst()) && A.is(L) && !A.hasAttribute("contenteditable")) { C = A.getElementsByTag("*");
                                m = 0; for (t = C.count(); m < t; m++)
                    ...
                    if (m) {
                        ...
                        for (g(p, A); t < p.length; t++) {
                            ...
                            if (M) F = 0 < t;
                                ...
                                if ((M = A.startPath().block) && !M.equals(E)) { if (y = M.getBogus()) y.remove(), C.push(M);
                                    E = M }
                                q.firstNotAllowed && (G = 1);
                                if (G && q.isElement) {
                                    M = A.startContainer;
                                    for (H = null; M && !v[M.getName()][q.name];) { if (M.equals(w)) { M = null; break }
                                        H = M;
                                        M = M.getParent() }
                    ...
                    if (!B.dontMoveCaret) {
                        for (E = e(y); E && a(E) && !E.is(v.$empty);) {
                            ...
                            else { if (f(E) && E.getHtml().match(/(\s|&nbsp;)$/g)) { Q = null; break }
                                Q = y.clone();
            ...
            tree: {
                rebuild: function(a, b) {
                    ...
                    if (e.blockLimit.is({
                        ...
                        g = function(a) { return !a.equals(v) } } else if (e.block && e.block.is(CKEDITOR.dtd.$listItem) && (f = f.contains(CKEDITOR.dtd.$list), c = c.contains(CKEDITOR.dtd.$list), !f.equals(c))) { var h = e.contains(CKEDITOR.dtd.$list).getParent();
                ...
                table: function() {
                    function a(c) {
                        ...
                        g.guard = function(a, g) {
                            if (a.type == CKEDITOR.NODE_ELEMENT) { var l = "visited_" + (g ? "out" : "in"); if (a.getCustomData(l)) return;
    ...
    (function() {
        ...
        CKEDITOR.on("instanceCreated", function(a) {
            ...
            c.on("contentDom", function() {
                ...
                CKEDITOR.env.gecko && k.attachListener(k, "focus", function(a) { a.removeListener();
                    0 !== z && (a = c.getSelection().getNative()) && a.isCollapsed && a.anchorNode == k.$ && (a = c.createRange(), a.moveToElementEditStart(k), a.select()) }, null, null, -2);
                ...
                if (CKEDITOR.env.ie || r) x ? k.attachListener(k, "beforedeactivate", a, null, null, -1) : k.attachListener(c, "selectionCheck", a, null, null, -1), k.attachListener(k, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function() { c.lockSelection(q);
                    z = 1 }, null, null, -1), k.attachListener(k, "mousedown", function() { z = 0 });
                if (CKEDITOR.env.ie && !r) {
                    ...
                    k.attachListener(k, "mouseup", function(a) { 2 == a.data.$.button && n && (c.document.$.documentElement.scrollLeft = n.x, c.document.$.documentElement.scrollTop = n.y);
                        n = null });
                        ...
                        if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) {
                            ...
                            l.on("mousedown", function(a) {
                                ...
                                function c() { l.removeListener("mousemove", b);
                                    ...
                                    m.select() }
                                a = a.data;
                                if (a.getTarget().is("html") && a.$.y < l.$.clientHeight && a.$.x < l.$.clientWidth) { m = t.$.createTextRange(); try { m.moveToPoint(a.$.clientX, a.$.clientY) } catch (d) {}
                                    w = m.duplicate();
                                    l.on("mousemove", b);
                                    p.on("mouseup", c);
                                    l.on("mouseup", c) }
                ...
                k.attachListener(k, "keydown", function(a) { var b = this.getSelection(1);
                    d(b) && (b.selectElement(d(b)), a.data.preventDefault()) }, c);
                k.attachListener(k, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function() { c.forceNextSelectionCheck();
                    c.selectionChange(1) });
                ...
                CKEDITOR.env.webkit && k.attachListener(h, "keydown", function(a) { switch (a.data.getKey()) {
                        case 13:
                        case 33:
                        case 34:
                        case 35:
        ...
        CKEDITOR.dom.selection.prototype = {
            ...
            getRanges: function() {
                var a = x ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        for (; 0 < h;) try { g = f[0 < q ? "previousSibling" : "nextSibling"], g.nodeType == CKEDITOR.NODE_TEXT && (h -= g.nodeValue.length, m = g), f = g } catch (n) { return { container: d, offset: a(f) } }
                    ...
                    if (this.isLocked) { var k = CKEDITOR.document.getActive();
                        ...
                        if (l) this.fake(l);
                            ...
                            if (x) {
                                ...
                                b = d.collapsed;
                                var t, G, m;
                                if ((e = d.getEnclosedNode()) && e.type == CKEDITOR.NODE_ELEMENT && e.getName() in D && (!e.is("a") || !e.getText())) try { m = e.$.createControlRange();
                                    m.addElement(e.$);
                                ...
                                for (m = 0; m < b.length; m++) {
                                    if (m <
                                        b.length - 1 && (t = b[m], G = b[m + 1], l = t.clone(), l.setStart(t.endContainer, t.endOffset), l.setEnd(G.startContainer, G.startOffset), !l.collapsed && (l.shrink(CKEDITOR.NODE_ELEMENT, !0), d = l.getCommonAncestor(), l = l.getEnclosedNode(), d.isReadOnly() || l && l.isReadOnly()))) { G.setStart(t.startContainer, t.startOffset);
                                        b.splice(m--, 1); continue }
                                    d = b[m];
                                    ...
                                    try { G.setEnd(d.endContainer.$, d.endOffset) } catch (u) { if (0 <= u.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) d.collapse(1), G.setEnd(d.endContainer.$, d.endOffset);
                                        else throw u; }
                                    k.addRange(G)
                                }
                            }
            ...
            removeAllRanges: function() { if (this.getType() != CKEDITOR.SELECTION_NONE) { var a = this.getNative(); try { a && a[x ? "empty" : "removeAllRanges"]() } catch (b) {}
                    this.reset() } }
        }
    })();
    "use strict";
    ...
    (function() {
                ...
                for (r.getPosition(u) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                    ...
                    if (r.equals(u)) r = null, l = !0;
                        ...
                        if (x && m && CKEDITOR.dtd.$block[A])
                            for (var y = r, z = e(y), D = void 0, H = z.length, I = 0, y = H && new CKEDITOR.dom.range(y.getDocument()); I < H; ++I) { var D = z[I],
                                    J = CKEDITOR.filter.instances[D.data("cke-filter")]; if (J ? J.check(this) : 1) y.selectNodeContents(D), b.call(this, y) }
        ...
        function c(a) {
            ...
            if (a.collapsed) {
                ...
                if (g) {
                    ...
                    n = this;
                b(); for (f = d; !f.equals(q);) g = f.getNextSourceNode(), f.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f) && (f.getName() == this.element ? A.call(this, f) : x(f, l(this)[f.getName()]), g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) && (b(), g = d.getNext())), f = g }
            a.moveToBookmark(c);
        ...
        function E(a) { for (var b = l(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;) d = c.getItem(e), d.isReadOnly() || A.call(this, d, !0); for (var f in b)
                if (f != this.element)
        ...
        function y(a, b) { var c = b._.definition,
                d = c.attributes,
        ...
        CKEDITOR.style.prototype = {
            apply: function(a) { if (a instanceof CKEDITOR.dom.document) return J.call(this, a.getSelection()); if (this.checkApplicable(a.elementPath(), a)) { var b = this._.enterMode;
                ...
                if ("string" == typeof this.element ?
                    d == this.element : d in this.element) { if (!b && !a.hasAttributes()) return !0; if (d = c._AC) c = d;
                        ...
                        c = c._AC = d } if (c._length) { for (var h in c)
                            if ("_length" != h)
                                if (d = a.getAttribute(h) || "", "style" == h ? I(c[h], d) : c[h] == d) { if (!b) return !0 } else if (b) return !1; if (b) return !0 } else return !0 }
                return !1
            },
        ...
        CKEDITOR.style.getStyleText = function(a) { var b = a._ST; if (b) return b; var b = a.styles,
                ...
                d = "";
            c.length && (c = c.replace(z, ";")); for (var e in b) { var f = b[e],
                    g = (e + ":" + f).replace(z, ";"); "inherit" == f ? d += g : c += g }
        ...
        CKEDITOR.dom.elementPath = function(b, e) {
            ...
            do
                if (n.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (n.equals(e)) break;
                    if (!h && (q = n.getName(),
                            "true" == n.getAttribute("contenteditable") ? h = n : !g && d[q] && (g = n), a[q])) { if (q = !g && "div" == q) { a: { q = n.getChildren(); for (var f = 0, C = q.count(); f < C; f++) { var w = q.getItem(f); if (w.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[w.getName()]) { q = !0; break a } }
                                q = !1 }
                            q = !q }
                        q ? g = n : h = n }
                }
    ...
    */
    ...
    (function() {
        ...
        CKEDITOR.plugins.add("clipboard", {
            ...
            init: function(b) {
                ...
                b.on("paste",
                    function(a) { a.data.dataTransfer || (a.data.dataTransfer = new CKEDITOR.plugins.clipboard.dataTransfer); if (!a.data.dataValue) { var c = a.data.dataTransfer,
    ...
    (function() {
        function l(a, c, f) { var d = CKEDITOR.cleanWord;
            d ? f() : (a = CKEDITOR.getUrl(a.config.pasteFromWordCleanupFile || c + "filter/default.js"), CKEDITOR.scriptLoader.load(a, f, null, !0)); return !d }
    ...
    (function() {
        function q(d, e) {
            function b(a) { return e ? e.contains(a) && a.getAscendant("table", !0).equals(e) : !0 }

            function c(b) { 0 < a.length || b.type != CKEDITOR.NODE_ELEMENT || !H.test(b.getName()) || b.getCustomData("selected_cell") || (CKEDITOR.dom.element.setMarker(g, b, "selected_cell", !0), a.push(b)) }
            if (d) {
                for (var f = d.getRanges(), a = [], g = {}, h = 0; h < f.length; h++) {
                    var k = f[h];
                    if (k.collapsed)(k = k.getCommonAncestor().getAscendant({ td: 1, th: 1 }, !0)) && b(k) && a.push(k);
                    else {
        ...
        function t(d, e) {
            for (var b = G(d) ? d : q(d), c = b[0], f = c.getAscendant("table"), c = c.getDocument(), a = b[0].getParent(), g = a.$.rowIndex, b = b[b.length - 1], h = b.getParent().$.rowIndex + b.$.rowSpan - 1, b = new CKEDITOR.dom.element(f.$.rows[h]), g = e ? g : h, a = e ? a : b, b = CKEDITOR.tools.buildTableMap(f),
                    f = b[g], g = e ? b[g - 1] : b[g + 1], b = b[0].length, c = c.createElement("tr"), h = 0; f[h] && h < b; h++) { var k;
        ...
        function D(d) {
            if (d instanceof CKEDITOR.dom.selection) {
                var e = d.getRanges(),
                    ...
                    b = b[b.length - 1],
                    g = b.getParent().$.rowIndex +
                    b.$.rowSpan - 1,
                    b = [];
                d.reset();
                for (d = a; d <= g; d++) { for (var h = f[d], k = new CKEDITOR.dom.element(c.$.rows[d]), l = 0; l < h.length; l++) { var r = new CKEDITOR.dom.element(h[l]),
        ...
        function B(d, e) { for (var b = d.getParent().$.cells, c = 0, f = 0; f < b.length; f++) { var a = b[f],
                    c = c + (e ? 1 : a.colSpan); if (a == d.$) break } return c - 1 }

        function w(d, e) { for (var b = e ? Infinity : 0, c = 0; c < d.length; c++) { var f = B(d[c], e); if (e ? f < b : f > b) b = f } return b }
        ...
        function m(d, e) { var b = d.getStartElement().getAscendant({ td: 1, th: 1 }, !0); if (b) { var c = b.clone();
                c.appendBogus();
        ...
        function v(d) {
            if (d instanceof CKEDITOR.dom.selection) {
                var e = d.getRanges(),
                    ...
                    f;
                a: {
                    var a = 0;f = b.length - 1;
                    for (var g = {}, h, k; h = b[a++];) CKEDITOR.dom.element.setMarker(g, h, "delete_cell", !0);
                    for (a = 0; h = b[a++];)
                        if ((k = h.getPrevious()) && !k.getCustomData("delete_cell") || (k = h.getNext()) && !k.getCustomData("delete_cell")) { CKEDITOR.dom.element.clearAllMarkers(g);
                            f = k; break a }
        ...
        function y(d, e, b) { d = d[e]; if ("undefined" == typeof b) return d; for (e = 0; d && e < d.length; e++) { if (b.is && d[e] == b.$) return e; if (e == b) return new CKEDITOR.dom.element(d[e]) } return b.is ? -1 : null }
        ...
        function A(d, e) {
            ...
            var b = b[0],
                ...
                k = b.$.rowSpan,
                l;
            if (1 < k) { l = Math.ceil(k / 2); for (var k = Math.floor(k / 2), c = g + l, f = new CKEDITOR.dom.element(f.$.rows[c]), a = y(a, c), r, c = b.clone(), g = 0; g < a.length; g++)
                    if (r = a[g], r.parentNode == f.$ && g > h) { c.insertBefore(new CKEDITOR.dom.element(r)); break } else r = null;
                r || f.append(c) } else
                for (k = l = 1,
            ...
            init: function(d) {
                ...
                b("cellProperties", new CKEDITOR.dialogCommand("cellProperties", e({
                    ...
                    contentTransformations: [
                        [{
                            element: "td",
                            left: function(a) { return a.styles.background && f.background(a.styles.background).color },
                            right: function(a) {
                ...
                b("rowDelete", e({ requiredContent: "table", exec: function(a) { a = a.getSelection();
                        (a = D(a)) && x(a) } }));
                b("rowInsertBefore", e({ requiredContent: "table", exec: function(a) { a = a.getSelection();
                        a = q(a);
                        t(a, !0) } }));
                b("rowInsertAfter", e({
                    requiredContent: "table",
                ...
                b("columnDelete", e({
                    ...
                    exec: function(a) {
                        ...
                        for (var m = 0, b = f.length; m < b; m++)
                            for (var u = 0, v = f[m].length; u < v; u++) f[m][u] == d.$ && (n = u), f[m][u] == e.$ && (p = u);
                        for (m = n; m <= p; m++)
                            for (u = 0; u < f.length; u++) e = f[u], d = new CKEDITOR.dom.element(c.$.rows[u]), e = new CKEDITOR.dom.element(e[m]), e.$ && (1 == e.$.colSpan ?
                ...
                b("columnInsertBefore", e({ requiredContent: "table", exec: function(a) { a = a.getSelection();
                        a = q(a);
                        p(a, !0) } }));
                b("columnInsertAfter", e({ requiredContent: "table", exec: function(a) { a = a.getSelection();
                        a = q(a);
                        p(a) } }));
                b("cellDelete", e({
                    requiredContent: "table",
                ...
                b("cellMerge", e({ allowedContent: "td[colspan,rowspan]", requiredContent: "td[colspan,rowspan]", exec: function(a, b) { b.cell = z(a.getSelection());
                        x(b.cell, !0) } }));
                b("cellMergeRight", e({ allowedContent: "td[colspan]", requiredContent: "td[colspan]", exec: function(a, b) { b.cell = z(a.getSelection(), "right");
                        x(b.cell, !0) } }));
                b("cellMergeDown", e({ allowedContent: "td[rowspan]", requiredContent: "td[rowspan]", exec: function(a, b) { b.cell = z(a.getSelection(), "down");
                        x(b.cell, !0) } }));
                b("cellVerticalSplit", e({ allowedContent: "td[rowspan]", requiredContent: "td[rowspan]", exec: function(a) { x(F(a.getSelection())) } }));
                b("cellHorizontalSplit", e({ allowedContent: "td[colspan]", requiredContent: "td[colspan]", exec: function(a) { x(A(a.getSelection())) } }));
                b("cellInsertBefore", e({ requiredContent: "table", exec: function(a) { a = a.getSelection();
                        m(a, !0) } }));
                b("cellInsertAfter", e({ requiredContent: "table", exec: function(a) { a = a.getSelection();
                        m(a) } }));
    ...
    CKEDITOR.tools.buildTableMap = function(q, t, D, B, w) { q = q.$.rows;
        D = D || 0;
        B = "number" === typeof B ? B : q.length - 1;
        w = "number" === typeof w ? w : -1; var p = -1,
            m = []; for (t = t || 0; t <= B; t++) { p++;!m[p] && (m[p] = []); for (var v = -1, x = D; x <= (-1 === w ? q[t].cells.length - 1 : w); x++) { var y = q[t].cells[x]; if (!y) break; for (v++; m[p][v];) v++; for (var z = isNaN(y.colSpan) ? 1 : y.colSpan, y = isNaN(y.rowSpan) ? 1 : y.rowSpan, A = 0; A < y && !(t + A > B); A++) { m[p + A] || (m[p + A] = []); for (var F = 0; F < z; F++) m[p + A][v + F] = q[t].cells[x] }
                v += z - 1; if (-1 !== w && v >= w) break } } return m };
    (function() {
        function B(a, b) {
            ...
            for (c = 0; c < k[f].length; c++)
                if (a.$ === k[f][c]) { n = c; break }
            for (c = 0; c < k[e].length; c++)
                if (b.$ === k[e][c]) { l = c; break }
            n > l && (c = n, n = l, l = c);
            for (c = f; c <= e; c++)
                for (f = n; f <= l; f++) d = new CKEDITOR.dom.element(k[c][f]),
        ...
        function D(a) { a = a.data.$; return CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? 1 === a.button : 0 === a.button }

        function J(a) { return (a = a.editable().findOne(".cke_table-faked-selection")) && a.getAscendant("table") }
        ...
        function x(a, b) { var c = [],
                d, k; for (k = 0; k < b.length; k++) d = a.createRange(), d.setStartBefore(b[k]), d.setEndAfter(b[k]), c.push(d);
        ...
        function L(a, b, c) { var d = t(a.getSelection(!0));
            b = b.is("table") ? null : b; var k;
            (k = h.active && !h.first) && !(k = b) && (k = a.getSelection().getRanges(), k = 1 < d.length || k[0] && !k[0].collapsed ? !0 : !1); if (k) h.first = b || d[0], h.dirty = b ? !1 : 1 !== d.length;
            else if (h.active && b) { d = B(h.first, b); if (!h.dirty && 1 === d.length) return C(a, "mouseup" === c.name);
                h.dirty = !0;
                h.last = b;
                x(a, d) } }
        ...
        function M(a) {
            var b = (a = a.editor || a.sender.editor) && a.getSelection(),
                ...
                d;
            if (b && (C(a),
                    b.isInTable() && b.isFake)) { 1 === c.length && c[0]._getTableElement() && c[0]._getTableElement().is("table") && (d = c[0]._getTableElement());
                d = t(b, d);
        ...
        function y(a) {
            ...
            function c(a) { return !a.getAscendant("table", !0) && a.getDocument().equals(d.document) }
            ...
            (function(a, d, f, e) { return "mousedown" === a.name && (D(a) || !e) || "mouseup" === a.name && !c(a.data.getTarget()) && !b(f, e) ? !0 : !1 })(a, k, f, e) && C(d, !0);
        ...
        function O(a, b) {
            ...
            f.getById("cke_table_copybin") || (l = f.createElement(n), m = f.createElement(n), m.setAttributes({ id: "cke_table_copybin", "data-cke-temp": "1" }), l.setStyles({ position: "absolute", width: "1px", height: "1px", overflow: "hidden" }), l.setStyle("ltr" == a.config.contentsLangDirection ? "left" : "right", "-5000px"), l.setHtml(a.getSelectedHtml(!0)), a.fire("lockSnapshot"), m.append(l), a.editable().append(m), q = a.on("selectionChange", c, null, null, 0), r && (z = p.scrollTop), e.selectNodeContents(l),
                e.select(), r && (p.scrollTop = z), setTimeout(function() { m.remove();
                    d.selectBookmarks(k);
                    q.removeListener();
                    a.fire("unlockSnapshot");
        ...
        function G(a) { var b = a.editor || a.sender.editor;
        ...
        function P(a) {
            ...
            function c(a) { var b = 0,
                    d; for (d = 0; d < a.length; d++) a[d].length > b && (b = a[d].length); return b }

            function d(a) { var b = a.getAscendant("table"),
                    d = a.getParent().$.rowIndex,
                    b = CKEDITOR.tools.buildTableMap(b),
                    c; for (c = 0; c < b[d].length; c++)
            ...
            if (e.getRanges().length && (e.isInTable() || (q = b(e))) && (g = t(e), g.length)) {
                ...
                w = u.getParent();
                if (!q)
                    for (f = 0; f < g.length; f++) g[f].setHtml("");
                if (1 < p.getChildCount() || !m) g[0].setHtml(p.getHtml()), k.fire("saveSnapshot");
                else {
                    if (q) {
                        g = l.getChildCount();
                    ...
                    for (f = 0; f < e.length; f++)
                        for (n = new CKEDITOR.dom.element(a.$.rows[l.$.rowIndex +
                                f]), g = 0; g < e[f].length; g++)
                            if (v = new CKEDITOR.dom.element(e[f][g]), p = q[f] && q[f][g] ? new CKEDITOR.dom.element(q[f][g]) : null, v && !v.getCustomData("processed")) { if (p && p.getParent()) v.replace(p);
                                else if (0 === g || e[f][g - 1])(p = 0 !== g ? new CKEDITOR.dom.element(e[f][g - 1]) : null) && n.equals(p.getParent()) ? v.insertAfter(p) : 0 < r ? v.insertAfter(new CKEDITOR.dom.element(n.$.cells[r])) : n.append(v, !0);
                                CKEDITOR.dom.element.setMarker(z, v, "processed", !0) } else v.getCustomData("processed") && p && p.remove();
                    CKEDITOR.dom.element.clearAllMarkers(z);
                    x(k, B(new CKEDITOR.dom.element(e[0][0]), v));
                    k.fire("saveSnapshot");
                    setTimeout(function() { k.fire("afterPaste") }, 0)
                }
            }
        }

        function F(a, b, c) { a.on("beforeCommandExec", function(d) {-1 !== CKEDITOR.tools.array.indexOf(b, d.data.name) && (d.data.selectedCells = t(a.getSelection())) });
            ...
            keyboardIntegration: function(a) {
                ...
                c.attachListener(c, "keydown", function(a) {
                        function c(b, f) {
                            ...
                            CKEDITOR.tools.array.forEach(l, function(a) { a.enlarge(CKEDITOR.ENLARGE_ELEMENT) });
                            var m = l[0].getBoundaryNodes(),
                                h = m.startNode,
                                m = m.endNode;
                            if (h && h.is && h.is(e)) {
                                for (var q = h.getAscendant("table", !0), g = h.getPreviousSourceNode(!1,
                                        CKEDITOR.NODE_ELEMENT, q), t = !1, u = function(a) { return !h.contains(a) && a.is && a.is("td", "th") }; g && !u(g);) g = g.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT, q);
                                !g && m && m.is && !m.is("table") && m.getNext() && (g = m.getNext().findOne("td, th"), t = !0);
                                if (g) k["moveToElementEdit" + (t ? "Start" : "End")](g);
                                else k.setStartBefore(h.getAscendant("table", !0)), k.collapse(!0);
                                l[0].deleteContents();
                                return [k]
                            }
                        ...
                        var f = { 37: 1, 38: 1, 39: 1, 40: 1, 8: 1, 46: 1 },
                            e = CKEDITOR.tools.extend({ table: 1 },
                                CKEDITOR.dtd.$tableContent);
                        delete e.td;
                        delete e.th;
                        return function(e) { var h = e.data.getKey(),
                                n, l = 37 === h || 38 == h,
                                m, t, q; if (f[h] && (n = a.getSelection()) && n.isInTable() && n.isFake)
                                if (m = n.getRanges(), t = m[0]._getTableElement(), q = m[m.length - 1]._getTableElement(), e.data.preventDefault(), e.cancel(), 8 < h && 46 > h) m[0].moveToElementEditablePosition(l ? t : q, !l), n.selectRanges([m[0]]);
                                else { for (e = 0; e < m.length; e++) b(m[e]);
                                    (e = c(t, m)) ? m = e: m[0].moveToElementEditablePosition(t);
                                    n.selectRanges(m);
                                    a.fire("saveSnapshot") } }
                    }(a),
                    null, null, -1);
                c.attachListener(c, "keypress", function(d) { var c = a.getSelection(),
                        f, e; if (c && c.isInTable() && c.isFake && d.data.$.charCode && !(d.data.getKeystroke() & CKEDITOR.CTRL)) { d = c.getRanges();
                        f = d[0].getEnclosedNode().getAscendant({ td: 1, th: 1 }, !0); for (e = 0; e < d.length; e++) b(d[e]);
                        d[0].moveToElementEditablePosition(f);
                        c.selectRanges([d[0]]) } }, null, null, -1)
            },
